...
<section class="py-10 bg-gray-200 from-fuchsia-600 to-blue-600 sm:py-16 lg:py-24">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
            ...
            <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-black">Here you can contact us.</p>
        </div>
                    ...
                    <div class="p-6 sm:p-10">
                        ...
                        <form action="#" method="POST" class="mt-8">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                                ...
                                <div>
                                    <label for="" class="text-base font-medium text-gray-900"> Problem </label>
                                    <div class="mt-2.5 relative">
                                        <input type="text" name="" id="" placeholder="" class="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 border border-gray-200 rounded-md bg-gray-50 focus:outline-none focus:border-blue-600 focus:bg-white caret-blue-600" />
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-8 space-y-7">
                                    <div class="flex items-start">
                                        ...
                                        <span class="block ml-3 text-base text-black"> ewejwhekjwekwbekwe, Spain </span>
                                    </div>
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <span class="block ml-3 text-base text-black"> Web3Basketball@gmail.com </span>
                                    </div>
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3">
                                            <span class="block text-base text-black"> (111) 444-444 </span>
                                            <span class="block mt-1 text-base text-black"> (111) 555-5555 </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
